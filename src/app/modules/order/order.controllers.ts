...
const orderProductController = async (req: Request, res: Response, next: NextFunction) => {
...
const revenueGenerateController = async (req: Request, res: Response, next: NextFunction) => {
    try {
